...
const projects = [
  {
    ...
    tech: [
      ...
      "Client Presentation",
      "Unit-Testing",
      "Advanced Features - AI ChatBOT",
      "API Integration",
      "Agents Development (with Kafka - Producer, Consumer, AgentsPooling)",
    ],
    year: "2025",
  },
  {
    title: "VS Events Website",
    description:
      "I developed a fully responsive static events management website from scratch using React. Completed the entire UI and deployed it in just 3 hours as a personal skill challenge",
    tech: [
      "React.js",
      "Mobile Responsive",
      "Client Presentation",
